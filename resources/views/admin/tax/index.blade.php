        ...
        <div class="wage_content">
            <div class="wage_data">
                <div class="datatable-container">
                    <h2 class="title">قائمة الضرائب</h2>
                    <div class="wage_box">
                        <button style="background: #6b8f96; padding:10px 20px; border:none; border-radius:10px; margin:0 0 10px 0;">
                            <a style="color: #ffff" href="{{ route('admin.tax.create') }}">إضافة ضريبة جديدة</a>
                        </button>
                    </div>
                    <div class="controls">
                            ...
                            <tbody id="table-body">
                                @foreach ($taxes as $tax)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.tax.edit', $tax->id) }}" class="btn btn-warning">تعديل</a>
                                            <form action="{{ route('admin.tax.delete', $tax->id) }}" method="POST" style="display:inline;">
                                                @csrf
